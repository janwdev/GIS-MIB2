    ...
    class Datepicker {
        ...
        show(state) {
            if (state) {
                ...
                const x = hostRect.x + (hostRect.width - frameRect.width) / 2;
                const y = hostRect.y + hostRect.height + 16;
        ...
        config(s) {
            ...
            else if ((this.lastDate ? Date.now() < this.lastDate.getTime() : true) &&
        ...
        load(mode) {
            ...
            const loadDays = () => {
                ...
                let index = (this.sunday ? 0 : 1) - (firstDayInMonth.getDay() || 7);
                for (let y = 0; y < 6; y++) {
                    const tr = document.createElement("tr");
                    table.append(tr);
                    for (let x = 0; x < 7; x++) {
                        let day = new Date(firstDayInMonth.getTime());
            ...
            const loadYears = () => {
                ...
                for (let y = 0; y < 5; y++) {
                    ...
                    table.append(row);
                    for (let x = 0; x < 5; x++) {
                        const index = this.date.getFullYear() -
